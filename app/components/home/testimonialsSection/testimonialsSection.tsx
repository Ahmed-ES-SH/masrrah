    ...
    >
          ...
          <div className="flex items-end gap-sm border-s border-embassy/25 ps-md lg:justify-self-end">
            <div className="pb-xxs">
              <p className="text-embassy">
                <span className="font-headline text-[2.75rem] font-semibold leading-none tracking-tight tabular-nums">
                  {content.rating}
                </span>
              ...
              <p className="mt-xs type-label uppercase text-embassy">
                {content.ratingLabel}
              </p>
              <p className="mt-xs flex items-center gap-xs type-label text-ink-soft">
                <FiCheck
        ...
        <div className="mt-lg grid gap-sm lg:grid-cols-[minmax(0,1.05fr)_minmax(0,1fr)] lg:gap-md">
          ...
          >
            ...
            <blockquote className="relative mt-lg max-w-[34ch] type-headline text-embassy">
              {featured.quote}
            </blockquote>

            <footer className="relative mt-auto flex items-center gap-sm border-t border-embassy/15 pt-md">
              <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-md border border-embassy/15 bg-marble font-headline text-title font-semibold text-embassy">
                {featured.initial}
              </span>
