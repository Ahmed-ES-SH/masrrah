...
export const TESTIMONIAL_CONTENT: Record<TestimonialLocale, TestimonialContent> = {
  ar: {
    ...
    body: "نحتفي بكل بيت شاركنا تجربته من أول استشارة حتى وصول الموظف. هذه الشهادات سُجِّلت كما قالها أصحابها، وننشرها بأمانة.",
    rating: "4.9",
  ...
  en: {
    ...
    body: "We hold every household that walked this path with us in high regard — from the first consultation to the worker's arrival. These words are recorded as their owners said them.",
    rating: "4.9",
